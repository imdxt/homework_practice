...
int display_jpeg_dj(char *filename, fb_info fb_in)
{
    ...
    u32_t *buf32 = rgb24to32(scale_buf, fb_in);
...
extern int m_x, m_y;
/*int display_one_small_jpeg(char *filename, fb_info fb_in, int x, int y)
{
...
u32_t * decode_small_jpeg(char *filename, fb_info fb_in)
{
    fb_info jpeg_inf;
...
int display_one_small_jpeg(u32_t *buf32, fb_info fb_in, int x, int y)
{
...
int disp_four_pic(int start_num)
{
    ...
    pos_start_t small_pos[4] = {
        {180, 110}, {521, 110}, {180, 366}, {521, 366}
    };
    ...
    if(m_x>180&&m_x<521+341-17&&m_y>110&&m_y<366+256)
        {
