...
void * slide_do(void *arg)
{
    while(*status_p == 2)
    {
        ...
        display_scale2(pic_pool[1], fb_inf);
...
int main(int argc, char *argv[]) 
{
    ...
    int song_flag1 = 0, song_flag2 = 0,song_flag3 = 0, song_flag4 = 0;
    ...
    display_string("退�?", 843, 343, fb_inf, COLOR);
                        ...
                        case 1: 
                            {
                                switch(tmp) 
                                {
                                    ...
                                    case 40:
                                        {
                                            display_mid_jpeg(pic_pool[position_id[0]], fb_inf, 180, 110);
                                        if(m_x>180&&m_x<521+341&&m_y>110&&m_y<366+256)
                                    ...
                                    case 41:
                                        {
                                            display_mid_jpeg(pic_pool[position_id[1]], fb_inf, 180, 110);
                                        if(m_x>180&&m_x<521+341&&m_y>110&&m_y<366+256)
                                            fb_savecursor (fb_inf,m_x,m_y);
                                            mid_flag = 1;
                                            break;
                                    ...
                                    case 42:
                                        {
                                            display_mid_jpeg(pic_pool[position_id[2]], fb_inf, 180, 110);
                                        if(m_x>180&&m_x<521+341&&m_y>110&&m_y<366+256)
                                            fb_savecursor (fb_inf,m_x,m_y);
                                            mid_flag = 1;
                                            break;
                                    ...
                                    case 43:
                                        {
                                            display_mid_jpeg(pic_pool[position_id[3]], fb_inf, 180, 110);
                                        if(m_x>180&&m_x<521+341&&m_y>110&&m_y<366+256)
                                            fb_savecursor (fb_inf,m_x,m_y);
                                            mid_flag = 1;
                                            break;
...
all_exit:display_jpeg14("EndPage.jpg",fb_inf); 
         if (init_ft("STLITI.TTF", 150) != 0) 
         {
             fprintf(stderr, "Error initial font\n");
             return -1;
         }

         display_string("谢谢使用!", 150, 450, fb_inf, 0xbf3eff);
         sleep(1);
         display_jpeg_dj("EndPage.jpg", fb_inf); 
         display_string("再见!", 150, 450, fb_inf, 0xbf3eff);
         sleep(1);
