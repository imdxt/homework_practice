...
extern int display_one_small_jpeg(u32_t *buf32, fb_info fb_in, int x, int y);
extern u32_t * decode_small_jpeg(char *filename, fb_info fb_in);
...
extern int display_scale1(char *filename, fb_info fb_inf);
